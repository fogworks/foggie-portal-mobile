          ...
          <nut-grid class="top_grid" :column-num="3">
            ...
            <nut-grid-item class="top_icon" text="Earnings" @click="router.push('/analysisCate?type=1')">
              <div>
                ...
                <p class="banlance_text">{{ cloudIncome }}<Search2></Search2>
                </p>
              </div>
            </nut-grid-item>
            <nut-grid-item class="top_icon" text="Expense" @click="router.push('/analysisCate?type=3')">
              <div>
                ...
                <p class="banlance_text1">{{ cloudExpense > 0 ? '-' : '' }}{{ cloudExpense }}<Search2></Search2>
                </p>
              </div>
            </nut-grid-item>
...
const cloudBalance = computed(() => {
  return Object.values(dmcCount.value).reduce((accumulator, current) => {
