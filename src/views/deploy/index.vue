  ...
  <div class="nft-page" v-if="isMobileDevice">
    ...
    <nut-form>
      ...
      <nut-form-item label="Image Link">
        <span @click="copyLink(contractData.metaImage)">
          {{ contractData.metaImage ? `${contractData.metaImage.substr(0, 20)}...${contractData.metaImage.substr(-15)}` : contractData.metaImage }}
        </span>
      </nut-form-item>
  ...
  .nft-page {
    ...
    .nut-cell-group__wrap {
      ...
      .customBox {
        ...
        color: #fff;
        .nut-range-container {
          ::v-deep .nut-range-max {
            color: #fff !important;
          }
          ::v-deep .nut-range-min {
            color: #fff;
          }
        }
      }
