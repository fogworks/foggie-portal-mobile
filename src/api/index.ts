...
export function searchOrder(data: any) {
    let url = `/dm/order/get_by_id`;
    return request({
        url: url,
        method: 'post',
        data,
...
export const update_deploy = (data: any) => {
    let url = `/nft_scanner/nft/update_deploy`;
    return request({
        url: url,
        method: 'POST',
        data,
...
export const nft_mint = (data: any) => {
    let url = `/nft_scanner/nft/mint`;
    return request({
        url: url,
        method: 'POST',
        data,
...
export const update_mint = (data: any) => {
    let url = `/nft_scanner/nft/update_mint`;
    return request({
        url: url,
        method: 'POST',
        data,
