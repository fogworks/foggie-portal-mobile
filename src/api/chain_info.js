...
export const getExplorerURI = (chainid,chainInfo) => {
  const _chain_info = !chainInfo ? getChainInfo(chainid) : chainInfo;
  return _chain_info ? (_chain_info.explorers && _chain_info.explorers?.length ? _chain_info.explorers[0].url : "") : "";
}

export const getNativeCurrency = (chainid,chainInfo) => {
  const _chain_info = !chainInfo ? getChainInfo(chainid) : chainInfo;
  return _chain_info ? (_chain_info.nativeCurrency ? _chain_info.nativeCurrency.symbol : "") : "";
}
...
const chain_info = [
  ...
  },
  {
    ...
    infoURL: "https://mainnet.ethwscan.com/",
